...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Service is running", "Il servizio 猫 in esecuzione"),
        ("Service is not running", "Il servizio non 猫 in esecuzione"),
        ...
        ("This is irreversible!", "Questo 猫 irreversibile!"),
        ("Deleting", "Eliminazione di"),
        ("files", "file"),
        ("Waiting", "In attesa"),
        ("Finished", "Completato"),
        ("Speed", "Velocit脿"),
        ("Custom Image Quality", "Qualit脿 immagine personalizzata"),
        ("Privacy mode", "Modalit脿 privacy"),
        ...
        ("Good image quality", "Qualit脿 immagine buona"),
        ("Balanced", "Bilanciata qualit脿/velocit脿"),
        ("Optimize reaction time", "Ottimizza tempo reazione"),
        ("Custom", "Profilo personalizzato"),
        ("Show remote cursor", "Visualizza cursore remoto"),
        ("Show quality monitor", "Visualizza qualit脿 video"),
        ...
        ("Please try later", "Riprova pi霉 tardi"),
        ("Remote desktop is offline", "Il desktop remoto 猫 offline"),
        ...
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a RustDesk il permesso 'Accessibilit脿'."),
        ...
        ("Your installation is lower version.", "Questa installazione non 猫 aggiornata."),
        ...
        ("setup_server_tip", "Per una connessione pi霉 veloce, configura uno specifico server"),
        ...
        ("Fix it", "Risolvi"),
        ("Warning", "Avviso"),
        ("Login screen using Wayland is not supported", "La schermata di accesso non 猫 supportata usando Wayland"),
        ...
        ("verification_tip", "脠 stato inviato un codice di verifica all'indirizzo email registrato, per accedere inserisci il codice di verifica."),
        ("Logout", "Esci"),
        ("Tags", "Etichette"),
        ("Search ID", "Cerca ID"),
        ...
        ("The verification code is incorrect or has expired", "Il codice di verifica non 猫 corretto o 猫 scaduto"),
        ...
        ("Discovered", "Rilevate"),
        ("install_daemon_tip", "Per avviare il programma all'accensione, 猫 necessario installarlo come servizio di sistema."),
        ("Remote ID", "ID remoto"),
        ("Paste", "Incolla"),
        ...
        ("Touch mode", "Modalit脿 tocco"),
        ("Mouse mode", "Modalit脿 mouse"),
        ...
        ("android_input_permission_tip1", "Affinch茅 un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a RustDesk di usare il servizio 'Accessibilit脿'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprir脿 di seguito, trova e accedi a [Servizi installati], attiva il servizio [RustDesk Input]."),
        ("android_new_connection_tip", "脠 stata ricevuta una nuova richiesta di controllo per il dispositivo attuale."),
        ("android_service_will_start_tip", "L'attivazione di Cattura schermo avvier脿 automaticamente il servizio, consentendo ad altri dispositivi di richiedere una connessione da questo dispositivo."),
        ("android_stop_service_tip", "La chiusura del servizio chiuder脿 automaticamente tutte le connessioni stabilite."),
        ...
        ("Someone turns on privacy mode, exit", "Qualcuno ha attivato la modalit脿 privacy, uscita"),
        ...
        ("Legacy mode", "Modalit脿 legacy"),
        ("Map mode", "Modalit脿 mappa"),
        ("Translate mode", "Modalit脿 traduzione"),
        ...
        ("Copied", "Copiato"),
        ("Exit Fullscreen", "Esci dalla modalit脿 schermo intero"),
        ...
        ("Ratio", "Rapporto"),
        ("Image Quality", "Qualit脿 immagine"),
        ...
        ("elevated_foreground_window_tip", "La finestra attuale del desktop remoto richiede per funzionare privilegi pi霉 elevati, quindi non 猫 possibile usare temporaneamente il mouse e la tastiera.\n脠 possibile chiedere all'utente remoto di ridurre a icona la finestra attuale o di selezionare il pulsante di elevazione nella finestra di gestione della connessione.\nPer evitare questo problema, ti consigliamo di installare il software nel dispositivo remoto."),
        ("Disconnected", "Disconnesso"),
        ("Other", "Altro"),
        ("Confirm before closing multiple tabs", "Conferma prima di chiudere pi霉 schede"),
        ...
        ("wayland_experiment_tip", "Il supporto Wayland 猫 in fase sperimentale, se vuoi un accesso stabile usa X11."),
        ...
        ("software_render_tip", "Se nel computer con Linux 猫 presente una scheda grafica Nvidia e la finestra remota si chiude immediatamente dopo la connessione, installa il nuovo driver open source e usa il rendering software.\nPotrebbe essere necessario un riavvio del programma."),
        ("Always use software rendering", "Usa sempre rendering software"),
        ("config_input", "Per controllare il desktop remoto con la tastiera, 猫 necessario concedere le autorizzazioni a RustDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, 猫 necessario concedere l'autorizzazione 'Registra audio' a RustDesk."),
        ("request_elevation_tip", "Se c'猫 qualcuno nel lato remoto 猫 possibile richiedere l'elevazione."),
        ("Wait", "Attendi"),
        ...
        ("Choose this if the remote account is administrator", "Scegli questa opzione se l'account remoto 猫 amministratore"),
        ...
        ("Default Image Quality", "Qualit脿 immagine predefinita"),
        ...
        ("relay_hint_tip", "Se non 猫 possibile connettersi direttamente, puoi provare a farlo tramite relay.\nInoltre, se si vuoi usare il relay al primo tentativo, 猫 possibile aggiungere all'ID il suffisso '/r\' o selezionare nella scheda se esiste l'opzione 'Collegati sempre tramite relay'."),
        ...
        ("empty_recent_tip", "Non c'猫 nessuna sessione recente!\nPianificane una."),
        ...
        ("Me", "Io"),
        ("identical_file_tip", "Questo file 猫 identico a quello nel dispositivo remoto."),
        ("show_monitors_tip", "Visualizza schermi nella barra strumenti"),
        ("View Mode", "Modalit脿 visualizzazione"),
        ...
        ("os_account_desk_tip", "Questo account viene usato per accedere al sistema operativo remoto e attivare la sessione desktop in modalit脿 non presidiata."),
        ("OS Account", "Account sistema operativo"),
        ("another_user_login_title_tip", "脠 gi脿 loggato un altro utente."),
        ("another_user_login_text_tip", "Separato"),
        ("xorg_not_found_title_tip", "Xorg non trovato."),
        ("xorg_not_found_text_tip", "Installa Xorg."),
        ("no_desktop_title_tip", "Non 猫 presente alcun ambiente desktop disponibile."),
        ...
        ("Can not be empty", "Non pu貌 essere vuoto"),
        ("Already exists", "Esiste gi脿"),
        ...
        ("scam_text2", "Probabilmente 猫 un truffatore che cerca di rubare i tuoi soldi o altre informazioni private."),
        ("Don't show again", "Non visualizzare pi霉"),
        ("I Agree", "Accetto"),
        ("Decline", "Non accetto"),
        ("Timeout in minutes", "Timeout in minuti"),
        ("auto_disconnect_option_tip", "Chiudi automaticamente sessioni in entrata per inattivit脿 utente"),
        ("Connection failed due to inactivity", "Connessione non riuscita a causa di inattivit脿"),
        ...
        ("Test", "Test"),
        ("display_is_plugged_out_msg", "Lo schermo 猫 scollegato, passo al primo schermo."),
        ...
        ("selinux_tip", "In questo dispositivo 猫 abilitato SELinux, che potrebbe impedire il corretto funzionamento di RustDesk come lato controllato."),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra RustDesk 猫 aperta"),
        ("no_need_privacy_mode_no_physical_displays_tip", "Nessun display fisico, nessuna necessit脿 di usare la modalit脿 privacy."),
        ...
        ("clear_Wayland_screen_selection_tip", "Dopo aver annullato la selezione schermo, 猫 possibile selezionare nuovamente lo schermo da condividere."),
        ("confirm_clear_Wayland_screen_selection_tip", "Sei sicuro di voler annullare la selezione schermo Wayland?"),
        ("android_new_voice_call_tip", "脠 stata ricevuta una nuova richiesta di chiamata vocale. Se accetti, l'audio passer脿 alla comunicazione vocale."),
        ("texture_render_tip", "Usa il rendering texture per rendere le immagini pi霉 fluide. Se riscontri problemi di rendering prova a disabilitare questa opzione."),
        ...
        ("During service is on", "Quando il servizio 猫 attivo"),
        ...
        ("one-way-file-transfer-tip", "Sul lato controllato  猫 abilitato il trasferimento file unidirezionale."),
        ("Authentication Required", "Richiesta autenticazione"),
        ("Authenticate", "Autentica"),
        ("web_id_input_tip", "脠 possibile inserire un ID nello stesso server, nel client web non 猫 supportato l'accesso con IP diretto.\nSe vuoi accedere ad un dispositivo in un altro server, aggiungi l'indirizzo del server (<id>@<indirizzo_server>?key=<valore_chiave >), ad esempio,\n9123456234@192.168.16.1:21117?key=5Qbwsde3unUcJBtrx9ZkvUmwFNoExHzpryHuPUdqlWM=.\nSe vuoi accedere ad un dispositivo in un server pubblico, inserisci \"<id>@public\", la chiave non 猫 necessaria per il server pubblico."),
        ("Download", "Download"),
        ...
        ("Untagged", "Senza tag"),
        ("new-version-of-{}-tip", "脠 disponibile una nuova versione di {}"),
        ...
        ("d3d_render_tip", "Quando 猫 abilitato il rendering D3D, in alcuni computer la schermata del telecomando potrebbe essere nera."),
        ...
        ("printer-requires-installed-{}-client-tip", "Per usare la stampa remota, {} 猫 necessario installare il programma nel dispositivo."),
        ("printer-{}-not-installed-tip", "La stampante {} non 猫 installata."),
        ("printer-{}-ready-tip", "La stampante {} 猫 installata e pronta all'uso."),
        ...
        ("dont-show-again-tip", "Non visualizzare pi霉 questo messaggio"),
        ("Take screenshot", "Cattura schermata"),
        ("Taking screenshot", "Cattura schermata"),
        ("screenshot-merged-screen-not-supported-tip", "L'unione della cattura di schermate di pi霉 display non 猫 attualmente supportata.\nPassa ad un singolo display e riprova."),
        ...
        ("{} Update", "Aggiorna {}"),
        ("{}-to-update-tip", "{} si chiuder脿 e installer脿 la nuova versione"),
        ("download-new-version-failed-tip", "Download non riuscito.\n脠 possibile riprovare o selezionare 'Download' per scaricare e aggiornarlo manualmente."),
        ...
        ("Trackpad speed", "Velocit脿 trackpad"),
        ("Default trackpad speed", "Velocit脿 predefinita trackpad"),
        ...
        ("The user is not an administrator.", "L'utente non 猫 un amministratore."),
        ("Failed to check if the user is an administrator.", "Impossibile verificare se l'utente 猫 un amministratore."),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, RustDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, RustDesk salter脿 il passaggio di verifica e proceder脿 in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione 猫 abilitata, RustDesk non user脿 pi霉 UDP 21116, verr脿 invece usato TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: il sistema operativo del server RustDesk non include questa funzionalit脿."),
