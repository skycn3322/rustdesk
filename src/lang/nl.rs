...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable file copy and paste", "Kopi毛ren en plakken van bestanden toestaan"),
        ("Connected", "Verbonden"),
        ...
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Ge茂nstalleerde Services], schakel de service [RustDesk Input] in."),
        ...
        ("scam_text2", "Het is waarschijnlijk een oplichter die probeert uw geld of andere priv茅gegevens te stelen."),
        ...
        ("wrong-2fa-code", "Kan de code niet verifi毛ren. Controleer of de code en lokale tijdinstellingen correct zijn."),
        ...
        ("no_need_privacy_mode_no_physical_displays_tip", "Geen fysieke schermen, geen priv茅modus nodig."),
        ...
        ("printer-requires-installed-{}-client-tip", "Om afdrukken op afstand te gebruiken, moet {} ge茂nstalleerd zijn op dit apparaat."),
        ("printer-{}-not-installed-tip", "De printer {} is niet ge茂nstalleerd."),
        ("printer-{}-ready-tip", "De printer {} is ge茂nstalleerd en klaar voor gebruik."),
        ...
        ("Save as", "Opslaan als"),
        ("Copy to clipboard", "Kopi毛ren naar het klembord"),
        ("Enable remote printer", "Printer op afstand inschakelen"),
        ("Downloading {}", "Downloaden {}"),
        ("{} Update", "{} Updaten"),
        ("{}-to-update-tip", "{} zal sluiten en de nieuwe versie installeren."),
        ("download-new-version-failed-tip", "Fout bij het downloaden. Je kunt het opnieuw proberen of op de knop Downloaden klikken om de applicatie van de offici毛le website te downloaden en handmatig bij te werken."),
        ("Auto update", "Automatisch updaten"),
        ("update-failed-check-msi-tip", "Kan de installatiemethode niet bepalen. Klik op 鈥淒ownloaden鈥?om de applicatie van de offici毛le website te downloaden en handmatig bij te werken."),
        ...
        ("Supported only in the installed version.", "Alleen ondersteund in de ge茂nstalleerde versie."),
