...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "Du kan f氓 adgang til ditt skrivebord med denne ID og passord."),
        ("Password", "Passord"),
        ("Ready", "Klar"),
        ...
        ("Service is running", "Tjenesten kj酶rer"),
        ("Service is not running", " tilknyttede tjenesten kj酶rer ikke"),
        ...
        ("Enable file transfer", "Aktiver filoverf酶rsel"),
        ...
        ("allowed characters", ""),
        ("id_change_tip", "Kun tegnene a-z, A-Z, 0-9, - (dash) og _ (understrek) er tillat. Den f酶rste bokstaven skal v忙re a-z, A-Z. Lengde mellom 6 og 16."),
        ("Website", "Hjemmeside"),
        ("About", "Om"),
        ("Slogan_tip", ""),
        ("Privacy Statement", ""),
        ...
        ("server_not_support", "Enda ikke st酶ttet av serveren"),
        ...
        ("Retry", "Pr酶v igjen"),
        ("OK", "OK"),
        ("Password Required", "passord p氓krevd"),
        ("Please enter your password", "Tast inn ditt passord"),
        ("Remember password", "Husk passord"),
        ("Wrong Password", "Feil passord"),
        ("Do you want to enter again?", "脴nsker du 氓 fors酶ke igen?"),
        ...
        ("Please try 1 minute later", "Pr酶v igen om et minutt"),
        ("Login Error", "Login feil"),
        ("Successful", "Vellykket"),
        ("Connected, waiting for image...", "Tilkoblet, venter p氓 bilde..."),
        ("Name", "Navn"),
        ("Type", "Type"),
        ("Modified", "Endret"),
        ("Size", "St酶rrelse"),
        ...
        ("Are you sure you want to delete this file?", "Er du sikker p氓, at du vil slette denne filen?"),
        ("Are you sure you want to delete this empty directory?", "Er du sikker p氓, at du vil slette dette tomme biblioteket?"),
        ("Are you sure you want to delete the file of this directory?", "Er du sikker p氓, at du vil slette filen til dette biblioteket?"),
        ("Do this for all conflicts", "Gj酶r dette for alle konflikter"),
        ...
        ("install_tip", "P氓 grunn av UAC kan RustDesk ikke fungere korrekt i enkelte tillfeller p氓 fjernskrivebordet. For 氓 unng氓 UAC klikker du p氓 knappen nedenfor for 氓 installere RustDesk p氓 systemet"),
        ("Click to upgrade", "Klikk for 氓 oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For 氓 kontrollere ditt skrivebord med fjernstyring m氓 du gi RustDesk \"Access \" Rettigheter."),
        ("config_screen", "For 氓 kunne f氓 adgang til ditt skrivebord med fjernstyring, m氓 du gi RustDesk \"skjerst酶tte \" tillatelser."),
        ...
        ("agreement_tip", "Hvis du starter installasjonen, m氓 du akseptere lisensavtalen"),
        ...
        ("setup_server_tip", "For en hurtigere tilkobling m氓 du bruke din egen tilkoblingsserver"),
        ...
        ("Auto Login", "Automatisk login (kun gyldig hvis du har konfigurert \"L氓s etter avslutting av sesjonen\")"),
        ...
        ("Fix it", "Kj酶r reparasjon"),
        ("Warning", "Advarsel"),
        ("Login screen using Wayland is not supported", "Login skjerm med Wayland st酶ttes ikke"),
        ...
        ("Discovered", "Oppdaget"),
        ("install_daemon_tip", "For 氓 starte n氓r PC'en har startet opp, m氓 du installere systemtjenesten"),
        ("Remote ID", "Fjern-ID"),
        ("Paste", "Sett inn"),
        ("Paste here?", "Sett inn her?"),
        ("Are you sure to close the connection?", "Er du sikker p氓 at du vil lukke tilkoblingn?"),
        ...
        ("Pinch to Zoom", "Knip for 氓 zoome inn"),
        ("Canvas Zoom", "Lerret zoom"),
        ("Reset canvas", "Nullstill lerret"),
        ("No permission of file transfer", "Ingen tillatelse til 氓 overf酶re filen"),
        ("Note", "Notat"),
        ...
        ("Open System Setting", "脜pne systeminnstillinger"),
        ("How to get Android input permission?", "Hvordan f氓r jeg en Android-input tillatelse?"),
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller ber酶ring, m氓 du gi RustDesk mulighet til 氓 bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "G氓 til den neste systeminnstillingssiden, s酶k og tast inn [installerte tjenester], aktiver [RustDesk Input] tjenesten."),
        ("android_new_connection_tip", "En ny foresp酶rsel ble mottatt, som 酶nsker 氓 kontrollere din n氓v忙rende enhet."),
        ("android_service_will_start_tip", "Ved 氓 aktivere skjermopptak startes tjenesten automatisk, s氓 andre enheter kan foresp酶rre en tilkobling fra denne enheten."),
        ("android_stop_service_tip", "Ved 氓 lukke tjenesten lukkes alle tilkoblinger automatisk."),
        ("android_version_audio_tip", "Den aktuelle Android-versjonen st酶tter ikke lydopptak. Android 10 eller nyere kreves."),
        ...
        ("Are you sure you want to restart", "Er du sikker p氓 at du vil restarte"),
        ("Restarting remote device", "Restarter fjernenhet"),
        ("remote_restarting_tip", "Enheten starter p氓 nytt - Lukker denne beskjeden og kobler til igjen om et 酶yeblikk"),
        ("Copied", "Kopiert"),
        ...
        ("Show Toolbar", "Vis Verkt酶ylinje"),
        ("Hide Toolbar", "Skjul Verkt酶ylinje"),
        ...
        ("Security", "Sikkerhet"),
        ("Theme", "Tema"),
        ("Dark Theme", "M酶rkt Tema"),
        ("Light Theme", "Lyst Tema"),
        ("Dark", "M酶rk"),
        ("Light", "Lys"),
        ("Follow System", "F酶lg System"),
        ("Enable hardware codec", "Aktiver hardware-codec"),
        ("Unlock Security Settings", "L氓s opp Sikkerhetsinnstillinger"),
        ("Enable audio", "Aktiver Lyd"),
        ("Unlock Network Settings", "L氓s opp Nettverksinnstillinger"),
        ("Server", "Server"),
        ...
        ("Prompt", "Prompt"),
        ("Please wait for confirmation of UAC...", "Vennligst vent p氓 UAC-bekreftelse..."),
        ("elevated_foreground_window_tip", ""),
        ("Disconnected", "Frakoblet"),
        ("Other", "Andre"),
        ("Confirm before closing multiple tabs", "Bekreft f酶r du lukker flere faner"),
        ...
        ("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Wayland krever en nyere versjon av Linux. Pr酶v X11 desktop eller skift OS."),
        ("JumpLink", "JumpLink"),
        ...
        ("Please wait for the remote side to accept your session request...", "Vennligst vent p氓 at fjernklienten aksepterer din sesjonsforesp酶rsel..."),
        ("One-time Password", "Engangskode"),
        ("Use one-time password", "Bruk engangskode"),
        ("One-time password length", "Engangskode lengde"),
        ("Request access to your device", "Ettersp酶r adgang til din enhet"),
        ("Hide connection management window", "Skjul tilkoblingsh氓ndteringsvinduet"),
        ("hide_cm_tip", ""),
        ("wayland_experiment_tip", ""),
        ("Right click to select tabs", "H酶yreklikk for 氓 velge faner"),
        ("Skipped", "Hoppet over"),
        ...
        ("Ask the remote user for authentication", "Sp酶r fjernbrukeren om godkjennelse"),
        ...
        ("Please confirm if you want to share your desktop?", "Bekreft at du 酶nsker 氓 dele skrivebordet ditt?"),
        ("Display", "Visning"),
        ...
        ("Codec", "Codec"),
        ("Resolution", "Oppl酶sning"),
        ("No transfers in progress", "Ingen aktive overf酶rsler"),
        ...
        ("Empty Username", "T酶m brukernavn"),
        ("Empty Password", "T酶m passord"),
        ("Me", "Meg"),
        ("identical_file_tip", ""),
        ("show_monitors_tip", ""),
        ("View Mode", ""),
