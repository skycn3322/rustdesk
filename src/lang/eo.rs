...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Enable clipboard", "Sinkronigi po艥on"),
        ...
        ("Clipboard is empty", "La po艥o estas malplena"),
        ("Stop service", "Haltu servon"),
        ("Change ID", "艤an臐i identigilon"),
        ...
        ("Website", "Retejo"),
        ("About", "Pri"),
        ("Slogan_tip", "Farita kun koro en 膲i tiu 磨aosa mondo!"),
        ("Privacy Statement", "Deklaro Pri Privateco"),
        ("Mute", "Muta"),
        ("Build Date", "konstruada dato"),
        ("Version", "Versio"),
        ("Home", "Hejmo"),
        ("Audio Input", "A怒dia Enigo"),
        ...
        ("invalid_http", "Devas komenci kun http:// a怒 https://"),
        ("Invalid IP", "IP nevalida"),
        ("Invalid format", "Formato nevalida"),
        ("server_not_support", "Ankora怒 ne subtenata de la servilo"),
        ("Not available", "Nedisponebla"),
        ("Too frequent", "Tro ofte 艥an臐ita, bonvolu reprovi poste"),
        ("Cancel", "Nuligi"),
        ("Skip", "Ignori"),
        ("Close", "Fermi"),
        ("Retry", "Reprovi"),
        ...
        ("Do you want to enter again?", "膱u vi aliri denove?"),
        ...
        ("Modified", "Modifita"),
        ("Size", "Grandeco"),
        ("Show Hidden Files", "Montri ka艥itajn dosierojn"),
        ("Receive", "Akcepti"),
        ("Send", "Sendi"),
        ...
        ("Delete", "Forigi"),
        ("Properties", "Propra牡oj"),
        ("Multi Select", "Pluropa Elekto"),
        ("Select All", "Elektu 膱iujn"),
        ("Unselect All", "Malelektu 膱iujn"),
        ("Empty Directory", "Malplena Dosierujo"),
        ("Not an empty directory", "Ne Malplena Dosierujo"),
        ("Are you sure you want to delete this file?", "膱u vi certas, ke vi volas forigi 膲i tiun dosieron?"),
        ("Are you sure you want to delete this empty directory?", "膱u vi certas, ke vi volas forigi 膲i tiun malplenan dosierujon?"),
        ("Are you sure you want to delete the file of this directory?", "膱u vi certa. ke vi volas forigi la dosieron de 膲i tiu dosierujo"),
        ("Do this for all conflicts", "Same por 膲iuj konfliktoj"),
        ("This is irreversible!", "膱i tio estas neinversigebla!"),
        ("Deleting", "Forigado"),
        ("files", "dosiero"),
        ("Waiting", "Atendante..."),
        ("Finished", "Finita"),
        ...
        ("Disable clipboard", "Malebligi po艥on"),
        ("Lock after session end", "艤losi foran komputilon post malkonektado"),
        ("Insert Ctrl + Alt + Del", "Enmeti Ctrl + Alt + Del"),
        ("Insert Lock", "艤losi foran komputilon"),
        ("Refresh", "Refre艥igi ekranon"),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron a怒 registri la ekranon. Bonvolu alkliku la butonon malsupre por instali RustDesk sur la operaciumo por eviti la demando supre."),
        ...
        ("Your installation is lower version.", "Via versio de instala牡o estas pli malalta ol la lasta."),
        ...
        ("Change Local Port", "艤an臐i Loka Pordo"),
        ("setup_server_tip", "Se vi bezonas pli rapida konekcio, vi povas krei vian propran servilon"),
        ("Too short, at least 6 characters.", "Tro mallonga, almena怒 6 signoj."),
        ("The confirmation is not identical.", "Amba怒 enigoj ne kongruas"),
        ...
        ("Connected", "Konektata"),
        ("Direct and encrypted connection", "Konekcio direkta 膲ifrata"),
        ("Relayed and encrypted connection", "Konekcio relajsa 膲ifrata"),
        ("Direct and unencrypted connection", "Konekcio direkta ne膲ifrata"),
        ("Relayed and unencrypted connection", "Konekcio relajsa ne膲ifrata"),
        ...
        ("Auto Login", "A怒tomata konektado (la 艥loso nur estos ebligita post la malebligado de la unua parametro)"),
        ("Enable direct IP access", "Permesi direkta eniro per IP"),
        ("Rename", "Renomi"),
        ("Space", "Spaco"),
        ("Create desktop shortcut", "Krei ligilon sur la labortablon"),
        ("Change Path", "艤an臐i vojon"),
        ...
        ("Always connect via relay", "膱iam konekti per relajso"),
        ("whitelist_tip", "Nur la IP en la blanka listo povas kontroli mian komputilon"),
        ("Login", "Ensaluti"),
        ("Verify", "Kontrolis"),
        ("Remember me", "Memori min"),
        ("Trust this device", "Fidu 膲i tiun aparaton"),
        ("Verification code", "Konfirmkodo"),
        ("verification_tip", "Konfirmkodo estis sendita al la registrita retpo艥ta adreso, enigu la konfirmkodon por da怒rigi ensaluti."),
        ("Logout", "Elsaluti"),
        ("Tags", "Etikedi"),
        ("Search ID", "Ser膲i ID"),
        ("whitelist_sep", "Vi povas uzi komon, punktokomon, spacon a怒 linsalton kiel apartigilo"),
        ("Add ID", "Aldoni identigilo"),
        ("Add Tag", "Aldoni etikedo"),
        ("Unselect all tags", "Malselekti 膲iujn etikedojn"),
        ("Network error", "Reta eraro"),
        ("Username missed", "Uzantnomo forgesita"),
        ("Password missed", "Pasvorto forgesita"),
        ("Wrong credentials", "Identigilo a怒 pasvorto erara"),
        ...
        ("install_daemon_tip", "Por komenci 膲e ek艥argo, oni devas instali sisteman servon."),
        ("Remote ID", "Fora identigilo"),
        ("Paste", "Alglui"),
        ("Paste here?", "Alglui 膲i tie?"),
        ("Are you sure to close the connection?", "膱u vi vere volas fermi la konekton?"),
        ("Download new version", "El艥uti la novan version"),
        ("Touch mode", "Tu艥a modo"),
        ...
        ("Do you accept?", "膱u vi akceptas?"),
        ("Open System Setting", "Malfermi Sistemajn Agordojn"),
        ("How to get Android input permission?", "Kiel akiri Android enigajn permesojn"),
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso a怒 tu艥o, vi devas permesi al RustDesk uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva pa臐o de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], 艥alti la servon [RustDesk Enigo]."),
        ("android_new_connection_tip", "Nova kontrolpeto estis ricevita, kiu volas kontroli vian nunan aparaton."),
        ("android_service_will_start_tip", "艤alti \"Ekrankapto\" a怒tomate startos la servon, permesante al aliaj aparatoj peti konekton al via aparato."),
        ("android_stop_service_tip", "Fermante la servon a怒tomate fermos 膲iujn establitajn konektojn."),
        ("android_version_audio_tip", "La nuna versio da Android ne subtenas sonkapton, bonvolu 臐isdatigi al Android 10 a怒 pli alta."),
        ("android_start_service_tip", "Frapu [Komenci servo] a怒 ebligu la permeson de [Ekrankapto] por komenci la servon de kundivido de ekrano."),
        ("android_permission_may_not_change_tip", "Permesoj por establitaj konektoj neble estas 艥an臐itaj tuj 臐is rekonektitaj."),
        ("Account", "Konto"),
        ("Overwrite", "anstata怒igi"),
        ("This file exists, skip or overwrite this file?", "膱i tiu dosiero ekzistas, 膲u preterlasi a怒 anstata怒i 膲i tiun dosieron?"),
        ("Quit", "Forlasi"),
        ("Help", "Helpi"),
        ("Failed", "Malsukcesa"),
        ("Succeeded", "Sukcesa"),
        ("Someone turns on privacy mode, exit", "Iu 艥altas modon privata, Eliro"),
        ...
        ("Failed to turn off", "Malsukcesis mal艥alti"),
        ("Turned off", "Mal艥altita"),
        ("Language", "Lingvo"),
        ("Keep RustDesk background service", "Tenu RustDesk fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas mal艥alti 膲i tiun funkcion, bonvolu iri al la sekva pa臐o de agordoj de la aplika牡o de RustDesk, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ("Start on boot", "Komencu 膲e ekfunkciigo"),
        ("Start the screen sharing service on boot, requires special permissions", "Komencu la servon de kundivido de ekrano 膲e lan膲o, postulas specialajn permesojn"),
        ("Connection not allowed", "Konekto ne rajtas"),
        ("Legacy mode", ""),
        ("Map mode", "Mapa modo"),
        ("Translate mode", "Traduki modo"),
        ("Use permanent password", "Uzu permanenta pasvorto"),
        ("Use both passwords", "Uzu amba怒 pasvorto"),
        ...
        ("Are you sure you want to restart", "膱u vi certas, ke vi volas restarti"),
        ("Restarting remote device", "Restartas fora aparato"),
        ("remote_restarting_tip", "Fora aparato restarti臐as, bonvolu fermi 膲i tiun mesa臐keston kaj rekonekti kun permanenta pasvorto post iom da tempo"),
        ("Copied", "Kopiita"),
        ("Exit Fullscreen", "Eliru Plenekranon"),
        ("Fullscreen", "Plenekrane"),
        ("Mobile Actions", "Po艥telefonaj Agoj"),
        ...
        ("Full Access", ""),
        ("Screen Share", ""),
        ("Wayland requires Ubuntu 21.04 or higher version.", "Wayland postulas Ubuntu 21.04 a怒 pli altan version."),
        ("Wayland requires higher version of linux distro. Please try X11 desktop or change your OS.", "Wayland postulas pli altan version de linuksa distro. Bonvolu provi X11-labortablon a怒 艥an臐i vian OS."),
        ("JumpLink", "View"),
        ("Please Select the screen to be shared(Operate on the peer side).", "Bonvolu Elekti la ekranon por esti dividita (Funkciu 膲e la sama flanko)."),
        ("Show RustDesk", ""),
        ("This PC", ""),
        ("or", ""),
        ("Continue with", ""),
